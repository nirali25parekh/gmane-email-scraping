...
# DNSMapping and Mapping is collected from gmane database
# People who have 
dnsmapping = dict()
mapping = dict()
...
# connect to database and make cursor object
conn = sqlite3.connect('index.sqlite')
cur = conn.cursor()

# Drop these tables if already exist
...
#~          guid: 
#~          sent_at: 
#~          sender_id: foreign key to senders table
#~          subject_id: foreign key to Subjects table
#~          header: compressed blob of headers
#~          body: compressed blob of body 
...
#~ Table Name: Replies
#~ Columns
#~          from_id: foreign key to Senders Table
#~          to_id: foreign key to Senders Table
